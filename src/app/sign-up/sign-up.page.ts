...
export class SignUpPage implements OnInit {
  ...
  imagepath: any;
  ornamentimage: any;
  constructor(private formBuilder: FormBuilder,private iab: InAppBrowser, private location: Location, private cameraService: CameraService, private helper: HelperService, private device: Device, private router: Router) { }
  ...
  signupSubmit() {
    ...
    this.helper.postMethod('register', body, res => {
      console.log(res)
